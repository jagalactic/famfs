...
static fence_fn_t fence_sfunc = NULL;
static fence_fn_t fence_mfunc = NULL;
static fence_fn_t fence_lfunc = NULL;
...
void flush_processor_cache(const void *addr, size_t len)
{
    ...
    fence_sfunc(); // ensure all prior memory ops complete before flushing
}
